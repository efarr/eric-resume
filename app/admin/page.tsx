    ...
    <SignedIn>
      ...
      <div className="mt-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <Link href="/admin/new-post" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Create New Post
          </Link>
        </div>
          ...
          <table className="min-w-full bg-white border border-gray-200">
            ...
            <tbody>
              {posts.length > 0 ? (
                ...
                <tr>
                  <td colSpan={4} className="py-4 px-4 text-center text-gray-500">No posts found</td>
                </tr>
              )}
            </tbody>
          </table>
